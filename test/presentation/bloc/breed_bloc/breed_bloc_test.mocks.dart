...
// in dog_app/test/presentation/bloc/breed_bloc/breed_bloc_test.dart.
...
import 'package:dog_app/core/usecases/usecase.dart' as _i7;
import 'package:dog_app/data/model/breed_model.dart' as _i6;
import 'package:dog_app/domain/usecases/get_breeds_usecase.dart' as _i3;
...
class MockGetBreedsUseCase extends _i1.Mock implements _i3.GetBreedsUseCase {
  MockGetBreedsUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.BreedModel>>> call(
          _i7.NoParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
